...
// The header (title left, Experiment ID right), the meta lines and the footer
// — the parts of a sheet that are the same whichever table sits between them.
// Each sheet adds its own `.title` and table styles.
export const PRINT_SHEET_SHARED_CSS = `
            .header {
              display: flex;
